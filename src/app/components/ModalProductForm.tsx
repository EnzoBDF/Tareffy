        ...
        <div className="grid grid-cols-3 gap-4 justify-items-center">
          <div className="col-span-2">
            ...
            <input
              ...
              style={{ boxShadow: "inset 0px 2px 4px rgba(0,0,0,0.25), inset 0px -2px 4px rgba(255,255,255,0.3)" }}
              className="bg-[#D9D9D9] text-black w-120 border border-gray-300 rounded-[0.5rem] px-3 py-[0.2rem]"
            />
          </div>
          ...
          <div className="col-span-1">
            ...
            <select
              ...
              style={{ boxShadow: "inset 0px 2px 4px rgba(0,0,0,0.25), inset 0px -2px 4px rgba(255,255,255,0.3)" }}
              className="bg-[#D9D9D9] text-black w-30 border border-gray-300 rounded-[0.5rem] px-3 py-[0.4rem]"
            >
